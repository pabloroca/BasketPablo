//
//  ExchangeDataControllerTests.swift
//  BasketPablo
//
...
class ExchangeDataControllerTests: XCTestCase {

   var itemsDatacontroller: ExchangeDataController!
   
   override func setUp() {
      super.setUp()
      
      self.itemsDatacontroller = ExchangeDataController()
      // clear entity
   ...
   func initData() {
      ...
      let data: NSData = info["DataExchange"] as! NSData
